...
function ispirit_js(op_str)
{
   ...
   */    
   ...
   {
	   window.external.OA_SMS("/newtouchHR/core/frame/2/index.jsp","","OPEN_URL");
 ...
 */
 ...
 if(module_id == "email"){            // 邮件
    windowtype = 'MAX';
    URL ="/newtouchHR/core/funcs/email/index.jsp";        
 }else if(module_id == "person_info"){  //用户信息
    URL ="/newtouchHR/core/funcs/userinfo/person.jsp?userId=<%=person.getSeqId()%>&windows=1";    
 }else if(module_id == "index"){        //首页
    windowtype = 'MAX';
    URL ="/newtouchHR/core/frame/2/index.jsp";   
 }else if(module_id == "group_msg"){     //群发信息
    windowtype = '416,300';
    URL ="/newtouchHR/core/funcs/message/smsgSend.jsp";   
 }
