...
function addRow(data , i,pageIndex,showLength){
	...
	var td = "<td>&nbsp;<input type='checkbox' name='deleteFlag' value='" + data.seqId +"'>"+"</td>"
	        ...
	        + "<td nowrap align='center'><a href='/newtouchHR/core/funcs/news/manage/newsAdd.jsp?seqId=" + data.seqId + "'> 修改</a>";
...
function show_reader(){
	 ...
	 URL="/newtouchHR/core/funcs/news/manage/showReader.jsp?seqId="+seqId;
