...
function addRow(data , i){
  ...
  var str = toNameStr + privNameStr + userNameStr;  
    ...
    td = td + "<td><a href='javascript:show_reader(" + data.seqId + ");' title='查阅情况'> 查阅情况</a>&nbsp;<a href='/newtouchHR/core/funcs/notify/manage/notifyAdd.jsp?seqId=" + data.seqId + "'> 修改</a>";
...
function back() {
	...
	window.location.href = "/newtouchHR/core/funcs/notify/manage/notifyQuery.jsp";
}
...
{
  URL="/newtouchHR/core/funcs/notify/manage/showObject.jsp?seqId="+seqId;
...
function my_affair(seqId)
{
  ...
  URL="/newtouchHR/core/funcs/notify/manage/note.jsp?seqId="+seqId;
...
{
 URL="/newtouchHR/core/funcs/notify/show/readNotify.jsp?isManage=1&seqId="+seqId;
...
{
  URL="/newtouchHR/core/funcs/notify/show/showReader.jsp?seqId="+seqId;
  myleft=(screen.availWidth-500)/2;
