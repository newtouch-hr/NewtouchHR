...
function addRegister(){
  window.location.href = "/newtouchHR/subsys/oa/fillRegister/attendScore/newRegister.jsp";
}

function historyRegister(){
  window.location.href = "/newtouchHR/subsys/oa/fillRegister/attendScore/historyRegister.jsp";
}
