...
<%
out.print("JHapparrayinfo[\"JH130\"] = [\"密码网发文\",'/newtouchHR/subsys/jtgwjh/sendDoc/indexSend.jsp',\"fa1\"];\n");
out.print("JHapparrayinfo[\"JH131\"] = [\"密码网收文\",'/newtouchHR/subsys/jtgwjh/receiveDoc/index.jsp',\"shou1\"];\n");
out.print("JHapparrayinfo[\"JH132\"] = [\"密码网查询\",'/newtouchHR/subsys/jtgwjh/search/indexSearch.jsp',\"cha1\"];\n");
out.print("(function($){\n"+
