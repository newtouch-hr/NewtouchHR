...
var jso = [
           ...
           ,{title:"ACT类配置",onload:showUserInfo.bind(window, "act"),useTextContent:true, contentUrl:"/newtouchHR/rad/CodeUtil/curd/act.jsp", imgUrl:"/yh/raw/ljf/imgs/1news.gif", useIframe:false}
           ,{title:"页面信息类配置",onload:showUserInfo.bind(window, "curd"),useTextContent:true, contentUrl:"/newtouchHR/rad/CodeUtil/curd/pages.jsp", imgUrl:"/yh/raw/ljf/imgs/1news.gif", useIframe:false}
           ,{title:"字段信息配置",onload:refrcahData.bind(window, "f"),useTextContent:true, contentUrl:"/newtouchHR/rad/CodeUtil/curd/fileds.jsp", imgUrl:"/yh/raw/ljf/imgs/1news.gif", useIframe:false}
           ];
//loadData();
