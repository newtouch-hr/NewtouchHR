...
function doInit(){
var jso = [
           {title:"实体类配置",onload:showUserInfo.bind(window, "pojo"),useTextContent:true, contentUrl:"/newtouchHR/raw/cy/codeutil/pojo.jsp", imgUrl:"/yh/raw/ljf/imgs/1news.gif", useIframe:false}
           ,{title:"ACT类配置",onload:showUserInfo.bind(window, "act"),useTextContent:true, contentUrl:"/newtouchHR/raw/cy/codeutil/act.jsp", imgUrl:"/yh/raw/ljf/imgs/1news.gif", useIframe:false}
           ,{title:"页面信息类配置",onload:showUserInfo.bind(window, "curd"),useTextContent:true, contentUrl:"/newtouchHR/raw/cy/codeutil/pages.jsp", imgUrl:"/yh/raw/ljf/imgs/1news.gif", useIframe:false}
           ,{title:"字段信息配置",onload:refrcahData.bind(window, "f"),useTextContent:true, contentUrl:"/newtouchHR/raw/cy/codeutil/fileds.jsp", imgUrl:"/yh/raw/ljf/imgs/1news.gif", useIframe:false}
           ];
//loadData();
