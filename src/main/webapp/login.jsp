			...
			<div class="login_boder">
				...
				<div class="login_padding" id="login_model">
					...
					<label> <input type="text" name="userName" id="userName"
						class="txt_input txt_input2" value="admin_HR">
					</label>
					<h2>密     码</h2>
					<label> <input type="password" name="pwd" id="pwd"
						class="txt_input" value="1qaz2wsx">
					</label>
					
					<div class="rem_sub">
					    <label>
						      <a class="sub_button" href="javascript:doLogin();" id="btnLogin" >
						      		<div class="rem_sub_l" style="text-align:center;width:145px;position:absolute; top:370px;">
