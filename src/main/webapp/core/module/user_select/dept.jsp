...
{
   parent.user.location="/newtouchHR/core/module/user_select/selected.jsp?TO_ID=<%=TO_ID%>&TO_NAME=<%=TO_NAME%>";
}
...
function CheckSend()
{
  ...
  if(kword.value == "" && $('search_icon').src.indexOf("/yh/core/module/user_select/quicksearch.gif") == -1)
	...
	{
     key = kword.value;
	   parent.user.location = "/newtouchHR/core/module/user_select/query.jsp?" + kword.value;
