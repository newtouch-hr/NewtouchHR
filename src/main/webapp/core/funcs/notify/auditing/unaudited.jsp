...
function addRow(data , i){
     ...
     var str = toNameStr + privNameStr + userNameStr;
	  var td =  "<td nowrap align='center' style='cursor:pointer'  title='部门："+data.deptName+"'>"+data.fromName+"</td>"
	            ...
	            + " <td nowrap align='center'> <a href='/newtouchHR/core/funcs/notify/auditing/pass.jsp?seqId="+data.seqId+"'>批准</a>"
	            + "&nbsp;&nbsp;<a href='/newtouchHR/core/funcs/notify/auditing/unPass.jsp?seqId="+data.seqId+"'>不批准</a></td>";
