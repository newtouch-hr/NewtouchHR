...
function initSwfUpload() {
    ...
    var settings = {
      ...
      upload_url: "/yh/newtouchHR/core/funcs/news/act/YHNewsHandleAct/fileLoad.act",
...
<form enctype="multipart/form-data" action="/yh/newtouchHR/core/funcs/news/act/YHNewsHandleAct/addNews.act" method="post" name="newsForm" id="newsForm">
...
<form id="formFile" action="/yh/newtouchHR/core/funcs/news/act/YHNewsHandleAct/uploadFile.act" method="post" enctype="multipart/form-data" target="commintFrame">
