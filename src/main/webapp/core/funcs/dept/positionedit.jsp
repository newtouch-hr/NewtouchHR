...
function nextDept(){
  location.href="/newtouchHR/core/funcs/dept/deptinput.jsp?deptLocal=" + deptLocal + "&deptParent=" + deptParent;
}
...
<body class="" topmargin="5" onload="doInit()">
 <table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
   <tr>
    ...
    <td align="right">
      <input type="button" value="新建岗位" class="BigButton" onClick="location='/newtouchHR/core/funcs/dept/positioninput.jsp?treeId='+treeId;" title=""新建岗位"">&nbsp;&nbsp;
