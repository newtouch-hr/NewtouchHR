	...
	function initNocbox(){
      ...
      openBtn.click(function(){
	   ...
	   $('#check_remind_histroy').live('click', function(){
         openURL("/newtouchHR/core/funcs/sms/index.jsp");   
	   });
	   ...
	   $('#ViewDetail').live('click',function(){
	   	...
	   	window.open('/newtouchHR/core/frame/ispirit/n12/module/index.jsp?SMS_ID_STR='+idstr+'&NAV_MAIN_URL='+encodeURIComponent(urlStr));
	   ...
	   $('#new_noc_list > div.noc_iterm > .noc_iterm_title > .noc_iterm_read').live('click',function(){
	    ...
	    var urlStr="";
	   	...
	   	url = '/newtouchHR/core/frame/ispirit/n12/module/index.jsp?SMS_ID_STR='+idstr+'&NAV_MAIN_URL='+encodeURIComponent(urlStr);
        	openURL(url);
	   });
